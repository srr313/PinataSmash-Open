...
/// @public
/// An array of NSString IDs for each of the gifts owned by the user, or nil if the user doesn't have any gifts
...
@property (nonatomic, assign, setter=setDelegate:)	id<CrystalPlayerDelegate> delegate;

@property (nonatomic)				int _updateState;
@property (nonatomic, retain)		CCPlayerData* _playerData;
@property (nonatomic)				BOOL _hasStartedUpdating;
