...
public class CrystalUnityBasic : MonoBehaviour 
{
	...
	public void ActivatePullTabUi(CrystalUnityBasic.ActivatePullTabUiType type, string edge)
	{
		if (isOkToRun())
		{
			Debug.Log("> CrystalUnityBasic ActivatePullTabUi, "+ type + ", " + edge + ", isOkToRun");
			AddCommand("ActivatePullTabUi|" + (int)type + "|" + edge);
		}
		else	
			Debug.Log("> CrystalUnityBasic ActivatePullTabUi, " + type);
	}
	...
	public void ActivatePullTabUiAtLeadboardWithId(string leaderboardId, string edge)
	{
		if (isOkToRun())
		{
			AddCommand("ActivatePullTabUiAtLeadboardWithId|" + leaderboardId + "|" + edge);
		}
		else
		{
			Debug.Log("> CrystalUnityBasic ActivatePullTabUiAtLeadboardWithId" + leaderboardId);
		}
	}
	
	/**
	 * Deactivates the Crystal pull tab UI
	 */
	...
	public void PostLeaderboardResult(string leaderboardId, float result, bool lowestValFirst)
	{
		...
		PostLeaderboardResult(leaderboardId, result, lowestValFirst, leaderboardId);
	}
	 ...
	 */
	public void PostLeaderboardResult(string leaderboardId, float result, bool lowestValFirst, string gcLeaderboardId)
	{
		if (isOkToRun())
		{
			AddCommand("PostLeaderboardResult|" + leaderboardId + "|" + result + "|" + lowestValFirst + "|" + gcLeaderboardId);
		}
		else
		{
			Debug.Log("> CrystalUnityBasic PostLeaderboardResult" + leaderboardId + ", " + result + ", " + lowestValFirst + ", " + gcLeaderboardId);
		}
	}
